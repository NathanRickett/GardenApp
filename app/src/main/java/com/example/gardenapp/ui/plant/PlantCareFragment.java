...
public class PlantCareFragment extends Fragment {
    ...
    public PlantCareFragment(PlantViewModel viewModel) {
     ...
     * @return A new instance of fragment PlantDatesFragment.
     */
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        this.care = view.findViewById(R.id.plant_care);
        this.care.setText(viewModel.getPlantCare());
    }
}